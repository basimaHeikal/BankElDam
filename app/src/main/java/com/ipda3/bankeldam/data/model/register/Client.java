...
package com.ipda3.bankeldam.data.model.register;
...
public class Client {
    ...
    public Client(String name, String email, String birthDate, String cityId, String phone, String donationLastDate, String bloodType) {
        this.name = name;
        this.email = email;
